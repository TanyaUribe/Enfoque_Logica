"""
La lógica temporal es una herramienta importante en la inteligencia artificial, 
especialmente en la representación del conocimiento y la planificación
de agentes racionales que interactúan con un entorno a lo largo del tiempo
Primero, se debe instalar la biblioteca "pddlpy" utilizando pip:
pip install pddlpy



Supongamos que queremos planificar un viaje en coche desde una ciudad A a una ciudad B. 
El viaje debe incluir cargar combustible en una gasolinera 
