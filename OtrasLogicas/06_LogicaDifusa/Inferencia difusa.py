...
Este código utiliza las reglas difusas definidas para calcular la velocidad del ventilador 
basada en los valores de temperatura y humedad ingresados. 
Puedes ajustar los valores de temperatura y humedad para observar cómo cambia la velocidad 
del ventilador de acuerdo con las reglas difusas definidas.
"""
import numpy as np
